              ...
              <v-dialog v-model="dialog" width="50%">
                ...
                <v-card>
                  ...
                  <v-card-text>
                    <v-container grid-list-md>
                      <form>
                        <v-layout row>
                          <v-flex xs12>
                            <v-text-field label="Nome do site" v-model="site.item.name">
                            </v-text-field>
                            <v-text-field label="Latitude" v-model="site.item.lattitude" type="number">
                            </v-text-field>
                            <v-text-field label="Longitude" v-model="site.item.longitude" type="number">
                            </v-text-field>
                            <v-text-field label="Banda larga do site" v-model="site.item.bandwidth" type="number" min="0">
                            </v-text-field>
                  ...
                  <v-card-actions>
                    ...
                    <v-btn class="blue--text darken-1" v-on:click.prevent="updateSite(site.item)" flat="flat" @click.native="dialog = false">Salvar alterações</v-btn>
                  </v-card-actions>
                </v-card>
              </v-dialog>
            </td>
